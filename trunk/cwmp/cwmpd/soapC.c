...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.5 2011-12-14 07:04:19 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_PointerTo_cwmp__GetAllQueuedTransfers:
		return soap_in_PointerTo_cwmp__GetAllQueuedTransfers(soap, NULL, NULL, "cwmp:GetAllQueuedTransfers");
...
{	(void)tag;
	...
	case SOAP_TYPE_PointerTo_cwmp__GetAllQueuedTransfers:
		return soap_out_PointerTo_cwmp__GetAllQueuedTransfers(soap, tag, id, (struct _cwmp__GetAllQueuedTransfers *const*)ptr, "cwmp:GetAllQueuedTransfers");
	case SOAP_TYPE_PointerTo_cwmp__FactoryResetResponse:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_PointerTo_cwmp__GetAllQueuedTransfersResponse:
		...
		break;
	case SOAP_TYPE_PointerTo_cwmp__GetAllQueuedTransfers:
		soap_serialize_PointerTo_cwmp__GetAllQueuedTransfers(soap, (struct _cwmp__GetAllQueuedTransfers *const*)ptr);
		break;
	case SOAP_TYPE_PointerTo_cwmp__FactoryResetResponse:
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->cwmp__GetAllQueuedTransfers = NULL;
}
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTo_cwmp__GetAllQueuedTransfers(soap, &a->cwmp__GetAllQueuedTransfers);
}
...
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_out_PointerTo_cwmp__GetAllQueuedTransfers(soap, "cwmp:GetAllQueuedTransfers", -1, &a->cwmp__GetAllQueuedTransfers, ""))
		return soap->error;
	return SOAP_OK;
}
...
{
	size_t soap_flag_cwmp__GetAllQueuedTransfers = 1;
	short soap_flag;
	...
	soap_default___cwmp__GetAllQueuedTransfers(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_cwmp__GetAllQueuedTransfers && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_cwmp__GetAllQueuedTransfers(soap, "cwmp:GetAllQueuedTransfers", &a->cwmp__GetAllQueuedTransfers, ""))
				{	soap_flag_cwmp__GetAllQueuedTransfers--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
				if (soap_flag)
...
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_out_PointerTo_cwmp__GetOptions(soap, "cwmp:GetOptions", -1, &a->cwmp__GetOptions, ""))
		return soap->error;
	return SOAP_OK;
}
...
{
	size_t soap_flag_cwmp__GetOptions = 1;
	short soap_flag;
	...
	soap_default___cwmp__GetOptions(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_cwmp__GetOptions && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_cwmp__GetOptions(soap, "cwmp:GetOptions", &a->cwmp__GetOptions, ""))
				{	soap_flag_cwmp__GetOptions--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
				if (soap_flag)
...
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_out_PointerTo_cwmp__SetVouchers(soap, "cwmp:SetVouchers", -1, &a->cwmp__SetVouchers, ""))
		return soap->error;
	return SOAP_OK;
}
...
{
	size_t soap_flag_cwmp__SetVouchers = 1;
	short soap_flag;
	...
	soap_default___cwmp__SetVouchers(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_cwmp__SetVouchers && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_cwmp__SetVouchers(soap, "cwmp:SetVouchers", &a->cwmp__SetVouchers, ""))
				{	soap_flag_cwmp__SetVouchers--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
				if (soap_flag)
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->cwmp__GetQueuedTransfers = NULL;
}
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerTo_cwmp__GetQueuedTransfers(soap, &a->cwmp__GetQueuedTransfers);
}
...
{	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_out_PointerTo_cwmp__GetQueuedTransfers(soap, "cwmp:GetQueuedTransfers", -1, &a->cwmp__GetQueuedTransfers, ""))
		return soap->error;
	return SOAP_OK;
}
...
{
	size_t soap_flag_cwmp__GetQueuedTransfers = 1;
	short soap_flag;
	...
	soap_default___cwmp__GetQueuedTransfers(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_cwmp__GetQueuedTransfers && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_cwmp__GetQueuedTransfers(soap, "cwmp:GetQueuedTransfers", &a->cwmp__GetQueuedTransfers, ""))
				{	soap_flag_cwmp__GetQueuedTransfers--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
				if (soap_flag)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_cwmp__GetAllQueuedTransfers(struct soap *soap, struct _cwmp__GetAllQueuedTransfers *const*a)
{
	if (!soap_reference(soap, *a, SOAP_TYPE__cwmp__GetAllQueuedTransfers))
		soap_serialize__cwmp__GetAllQueuedTransfers(soap, *a);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_cwmp__GetAllQueuedTransfers(struct soap *soap, const char *tag, int id, struct _cwmp__GetAllQueuedTransfers *const*a, const char *type)
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE__cwmp__GetAllQueuedTransfers);
	if (id < 0)
		return soap->error;
	return soap_out__cwmp__GetAllQueuedTransfers(soap, tag, id, *a, type);
}

SOAP_FMAC3 struct _cwmp__GetAllQueuedTransfers ** SOAP_FMAC4 soap_in_PointerTo_cwmp__GetAllQueuedTransfers(struct soap *soap, const char *tag, struct _cwmp__GetAllQueuedTransfers **a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 1, NULL))
		return NULL;
	if (!a)
		if (!(a = (struct _cwmp__GetAllQueuedTransfers **)soap_malloc(soap, sizeof(struct _cwmp__GetAllQueuedTransfers *))))
			return NULL;
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		if (!(*a = soap_in__cwmp__GetAllQueuedTransfers(soap, tag, *a, type)))
			return NULL;
	}
	else
	{	a = (struct _cwmp__GetAllQueuedTransfers **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__cwmp__GetAllQueuedTransfers, sizeof(struct _cwmp__GetAllQueuedTransfers), 0);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_cwmp__GetAllQueuedTransfers(struct soap *soap, struct _cwmp__GetAllQueuedTransfers *const*a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_PointerTo_cwmp__GetAllQueuedTransfers);
	if (soap_out_PointerTo_cwmp__GetAllQueuedTransfers(soap, tag?tag:"cwmp:GetAllQueuedTransfers", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct _cwmp__GetAllQueuedTransfers ** SOAP_FMAC4 soap_get_PointerTo_cwmp__GetAllQueuedTransfers(struct soap *soap, struct _cwmp__GetAllQueuedTransfers **p, const char *tag, const char *type)
{
	if ((p = soap_in_PointerTo_cwmp__GetAllQueuedTransfers(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
